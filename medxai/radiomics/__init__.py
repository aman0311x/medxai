...
def extract_glcm(image: np.ndarray, distances: List[int] = [1], angles: List[float] = [0.0]) -> Dict[str, float]:
...
def extract_lbp_hist(image: np.ndarray, radius: int = 1, n_points: int = 8) -> np.ndarray:
